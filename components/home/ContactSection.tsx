          ...
          <div className="md:w-7/12 py-16 md:py-20 px-4 sm:px-8 md:pl-16 lg:pl-24">
            ...
            <div className="mb-10 space-y-3">
              <p className="flex gap-3 text-sm">
                <span className="font-semibold text-[#1a1a2e] w-12">Phone:</span>
              ...
              <p className="flex gap-3 text-sm">
                <span className="font-semibold text-[#1a1a2e] w-12">E-Mail:</span>
                <a href="mailto:info@email.com" className="text-[#b99566] hover:underline">info@email.com</a>
              </p>
            </div>

            {/* Address Info */}
            <div className="space-y-4">
              <h3 className="text-lg font-bold text-[#1a1a2e]">Address Information</h3>
              <div className="flex items-start gap-3">
                <MapPin className="w-5 h-5 text-[#b99566] shrink-0 mt-0.5" />
                <span className="text-sm text-gray-600">203 Fake St. Mountain View, San Francisco, California, USA</span>
              </div>
              <div className="flex items-center gap-3">
                <Phone className="w-5 h-5 text-[#b99566] shrink-0" />
                <span className="text-sm text-gray-600">(00) 123 - 456 - 789</span>
              </div>
              <div className="flex items-center gap-3">
                <Mail className="w-5 h-5 text-[#b99566] shrink-0" />
                <a href="mailto:info@email.com" className="text-sm text-[#b99566] hover:underline">info@email.com</a>
              </div>
            </div>
          </div>
        </div>
